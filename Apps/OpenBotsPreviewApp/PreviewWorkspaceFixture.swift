...
/// Process-local preview data. It deliberately exercises the real
/// presentation seams without opening storage, Keychain, Claude, a runtime
/// process, or the network.
@MainActor
final class PreviewWorkspaceFixture: ObservableObject {
...
struct PreviewWorkspaceView: View {
    @ObservedObject var fixture: PreviewWorkspaceFixture
    ...
    var body: some View {
        ...
        .sheet(item: $fixture.creationModel) { model in
            TeammateCreationView(model: model, onCancel: { fixture.creationModel = nil })
        }
    }
}
